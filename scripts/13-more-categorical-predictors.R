...
ecls = read.csv(file = "~/Documents/epsy-8251/data/ecls.csv")
head(ecls)
...
lm.asian = lm(read ~ black + hispanic + other + white, data = ecls)
summary(lm.asian)


# Black is reference group
lm.black = lm(read ~ asian + hispanic + other + white, data = ecls)
summary(lm.black)


# Hispanic is reference group
lm.hispanic = lm(read ~ asian + black + other + white, data = ecls)
summary(lm.hispanic)


# Other is reference group
lm.other = lm(read ~ asian + black + hispanic + white, data = ecls)
summary(lm.other)


# White is reference group
lm.white = lm(read ~ asian + black + hispanic + other, data = ecls)
summary(lm.white)
...
# Asian is reference group
lm.asian = lm(read ~ black + hispanic + other + white + ses + momEd, data = ecls)
summary(lm.asian)


# Black is reference group
lm.black = lm(read ~ asian + hispanic + other + white + ses + momEd, data = ecls)
summary(lm.black)


# Hispanic is reference group
lm.hispanic = lm(read ~ asian + black + other + white + ses + momEd, data = ecls)
summary(lm.hispanic)


# Other is reference group
lm.other = lm(read ~ asian + black + hispanic + white + ses + momEd, data = ecls)
summary(lm.other)


# White is reference group
lm.white = lm(read ~ asian + black + hispanic + other + ses + momEd, data = ecls)
summary(lm.white)
