...
- `fcc_availability`: Percent of people in the county with access to fixed terrestrial broadband at speeds of 25 Mbps/3 Mbps as of the end of 2019 as measured by the FCC
- `microsoft_useage`: Percent of people in the county that use the internet at broadband speeds estimated by Microsoft
