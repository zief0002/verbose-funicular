...
- M1: Contraception use in a country is thought to be negatively associated with fertility rates.
- M2: Women in countries with higher infant mortality rates will, on average, have more children (higher fertility rates). Controlling for the infant mortality rate is important to gain a more accurate view of the effect of contraception use on fertility rate.
- M3: Contraception use is really a function of educating women, so after controlling for education there is no/little effect of contracption use on fertility rate. In this model we will also still control for infant mortality rates.
