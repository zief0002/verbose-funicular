...
12. Create a publication quality plot that displays the results from Model 2. For this plot, put the beauty predictor on the *x*-axis. Show two separate lines to show the effect of the percentage of students evaluating the course (a small and large percentage). These lines should have different linetypes or use different colors so that they can easily be differentiated. **(2pts.)**
